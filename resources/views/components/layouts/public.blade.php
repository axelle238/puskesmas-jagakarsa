        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="/" wire:navigate class="flex flex-col">
                ...
                <nav class="hidden md:flex space-x-8 items-center">
                    ...
                    <a href="/fasilitas" wire:navigate class="text-gray-600 hover:text-medis-600 font-medium transition">Fasilitas</a>
                    <a href="/edukasi" wire:navigate class="text-gray-600 hover:text-medis-600 font-medium transition">Edukasi</a>
    ...
    <footer class="bg-gray-900 text-white pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    <h4 class="text-lg font-bold mb-6 border-b border-gray-700 pb-2 inline-block">Menu</h4>
                    <ul class="space-y-3 text-gray-400">
                        <li><a href="/fasilitas" class="hover:text-medis-400 transition">Fasilitas</a></li>
                        <li><a href="/edukasi" class="hover:text-medis-400 transition">Artikel Kesehatan</a></li>
                        <li><a href="/antrian" class="hover:text-medis-400 transition">Antrian Online</a></li>
                    </ul>
                </div>
                <div>
